...
<div class="login-box">
    <div class="login-logo">
        <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}">{!! config('adminlte.logo', '<b>Sistema</b>Leads') !!}</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <div class="auth-links">
            ...
            <a href="/admin/login" class="text-center">Entrar como administrador</a>
        </div>
    </div>
    <!-- /.login-box-body -->
</div>
