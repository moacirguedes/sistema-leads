...
<div class="container width550">
    <div class="box box-solid box-default">
        ...
        <div class="box-body">
            <form id="form" action="{{ route('consumed.store', $id) }}" method="post">
                {!! csrf_field() !!}
                ...
                <fieldset class="form-group">
                    ...
                    Lead
                        ...
                        <div class="form-check col-sm-4">
                            <input checked class="form-check-input" type="radio" name="client" id="gridRadios2" value="1" required oninput='on_change(event)'>
