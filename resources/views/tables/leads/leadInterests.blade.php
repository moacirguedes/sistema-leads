...
@section('title', 'Interesses do lead') 
...
<div class="displayinline">
    <h3 class="displayinline">Perfil do Lead</h3>
</div>


@stop
    @include('partials.includes')
    @include('tables.table-partials.profile.leadclientProfile', ['lead_client' => $lead])
    @include('tables.table-partials.profile.leadClientEditModal', ['lead_client' => $lead])

<div class="box">
    <div class="box-header">
        <h2 class="box-title">Lista de Interesses</h2>
        <a href="{{ route('interest.create', $lead->id) }}" class="displayinline btn btn-primary btn-flat rightside">Adicionar Interesse</a>
    </div>
    <div class="box-body">
        <table id="leadsInterestsTable" class="table table-bordered table-striped table-hover nodisplay" width="100%">
            ...
            <?php foreach ($interests as $index => $interest) : ?>
                ...
                <tr>
                    ...
                    <?php endif ?>
                    <td class="textcenter">
                        <a href="{{ route('interest.edit', $interest->pivot->id) }}">
                            <button class="btn btn-primary btn-flat fa fa-edit"></button>
                        </a>
                        <form class="displayinline" action="{{ route('interest.destroy', $interest->pivot->id) }}" method="post">
...
<div id="valueEdit" class="modal fade" role="dialog">
